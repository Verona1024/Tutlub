...
/**
 * Created by verona1024 on 30.06.17.
 */
...
//        Log.e("refreshedToken ", "" refreshedToken);
    ...
    private void sendRegistrationToServer(String token) {
        ...
        Call<ResponseBody> call =  trackerInternetProvider.loginUser(UserUtil.getUserLogin(getApplicationContext()),
                UserUtil.getUserPass(getApplicationContext()), token);
    }
